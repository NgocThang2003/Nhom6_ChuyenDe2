...
public class Shipper_DonHangCuaBan_Holder extends RecyclerView.ViewHolder {
    Button btnGoiDien, btnTinNhan, btnXacNhanLayHang;
    ImageView ivHinh;
    TextView tvTenKH, tvDiaChi, tvTenSP, tvMoTa, tvSDT, tvGia, tvSoLuong, tvNgay, tvTrangThai, tvThanhTien;
    public Shipper_DonHangCuaBan_Holder(@NonNull View itemView) {
        super(itemView);
        btnGoiDien = itemView.findViewById(R.id.btnGoiDien);
        btnTinNhan = itemView.findViewById(R.id.btnNhanTin);
        btnXacNhanLayHang = itemView.findViewById(R.id.btnXacNhanLayHang);
