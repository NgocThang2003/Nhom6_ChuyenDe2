...
public class MainActivity_ShipperDonHangDangGiao extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_shipperdonhangdanggiao);
        setControl();
        setEvent();
    }
    ...
    public void DocDL() {
        data_DonHang.clear();
        data_DHDG.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
